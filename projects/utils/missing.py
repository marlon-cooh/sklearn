# API Pandas extension for treating and visualizing missing values.
import itertools
import pandas as pd
    ...
    def scatter_imputation_plot(
        ...
        **kwargs
        ...
        return (
            ...
            .assign(
                is_imputed=lambda df: df[x_imputed] | df[y_imputed]
            )
            .pipe(
                lambda df: (
                    plot_func(
                        ...
                        y=y,
                        hue="is_imputed",
                        **kwargs # all the other arguments for seaborn plots
                    )
                )
            )
        )